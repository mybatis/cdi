...
/**
 * Enum of isolation levels. This enum exists because Java annotations do not
 * support null default values - so we need to add the DEFAULT level which means
 * - do not specify an isolation level.
 *
 * @author Jeff Butler
 */
